...
export const WaveDividerTop = ({ fill = "#ffffff" }: { fill?: string }) => (
...
export const WaveDividerBottom = ({ fill = "#ffffff" }: { fill?: string }) => (
...
export const OrganicTornTop = ({ fill = "#ffffff" }: { fill?: string }) => (
  <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] rotate-180 z-10">
    <svg
